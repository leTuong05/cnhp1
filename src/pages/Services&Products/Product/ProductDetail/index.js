...
const listImage = [require('../../../../common/images/sanpham-1.png'), require('../../../../common/images/sanpham-1.png'), require('../../../../common/images/sanpham-1.png'), require('../../../../common/images/sanpham-1.png')];
        ...
        <Wrapper>
                ...
                <Row>
                    ...
                    <Col span={8}>
                        ...
                        <ProductRate>
                            ...
                            <span className="rate-text">{productDetail.QuantityRating} đánh giá</span>
                        </ProductRate>
            ...
            <Row gutter={15}>
                <Col span={18} className="content">
                    <WrapperDescription>
                        <div className="title">
                            <TitleStyled size="18px" weight="600">
                                Mô tả
                            </TitleStyled>
                            <Line />
                        </div>
                        <div dangerouslySetInnerHTML={{ __html: productDetail.Description }} className="description"></div>
                    </WrapperDescription>
                    <WrapperRate>
                        <div className="title">
                            <TitleStyled size="18px" weight="600">
                        ...
                        <RateComponent id={id} listRate={productDetail.Stars}></RateComponent>
                    </WrapperRate>
                </Col>
                <Col span={6}>
