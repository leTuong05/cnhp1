...
import {
  ...
  updatePostList,
  uploadFileMuti,
} from "../services/apis/postsCategoryy";
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchUpdatePostList.rejected, (state, action) => {
        ...
        // message.error(state.error.error.Object);
      });
  },
});
...
export const fetchCategoryPost = createAsyncThunk(
  "listsCategory/fetchCategoryPost",
  async () => {
    try {
...
export const fetchDeletePostList = createAsyncThunk(
  "deletePostList/fetchDeletePostList",
  async (id) => {
    try {
...
export const fetchInsertPostList = createAsyncThunk(
  "addPostList/fetchInsertPostList",
  async (body, { rejectWithValue }) => {
    try {
...
export const fetchUpdatePostList = createAsyncThunk(
  "editPostList/fetchUpdatePostList",
  async (body, { rejectWithValue }) => {
    try {
...
export const fetchCancelPostList = createAsyncThunk(
  "cancelPostList/fetchCancelPostList",
  async (id) => {
    try {
...
export const fetchGetDetailByID = createAsyncThunk(
  "getPostDetailByID/fetchGetDetailByID",
  async (id) => {
    try {
